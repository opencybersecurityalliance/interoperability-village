...
The **IoV Central Hub**—also known as the *Town Council* and *Zoning Commission*—runs a central instance of [MeshCentral](https://meshcentral.com/downloads.html) on AWS, acting as the provisioning and orchestration backbone.
